        ...
        <div className={styles.section}>
          ...
          <div className={styles.goboVisualSection}>
            ...
            <div className={styles.connectionControls}>
              <div className={styles.midiRangeSection}>
                <button 
                  className={`${styles.midiLearnBtn} ${midiLearnTarget === 'shutter' ? styles.learning : ''}`}
                  onClick={() => midiLearnTarget === 'shutter' ? stopMidiLearn() : startMidiLearn('shutter')}
                >
                  <LucideIcon name="Music" />
                  MIDI Learn
                </button>
      ...
      <div className={styles.debugSection}>
        ...
        <div className={styles.debugControls}>
          <button 
            ...
            onClick={() => {
              if (fixtures.length > 0) {
                ...
                console.log(`[DEBUG] Auto-selected first fixture: ${fixtures[0].name} (${fixtures[0].id})`);
              }
            }}
          >
          ...
          <button 
            ...
            onClick={() => {
              const affected = getAffectedFixtures();
              console.log(`[DEBUG] Currently affected fixtures:`, affected);
              console.log(`[DEBUG] Selection mode: ${selectionMode}`);
              console.log(`[DEBUG] Selected fixtures: ${selectedFixtures.length}`, selectedFixtures);
            }}
          >
            Check Selection
          </button>
          <button 
            className={styles.debugBtn}
            onClick={() => {
              console.log(`[DEBUG] Testing DMX output - setting channel 1 to 127`);
              setDmxChannelValue(1, 127);
            }}
          >
            Test DMX Channel 1
          </button>
