...
graph TD
    subgraph SystemArchitecture["🧠 FUNCTIONAL ARCHITECTURE"]
        ...
        subgraph Layer3["👁️ Layer 3: Visual Perception"]
            WebGLUniverse["🌈 WebGL Reality Mirror"]
            PerceptionMatrix["📊 Perception Matrix"]
        end
        
        subgraph Layer2["⚡ Layer 2: Signal Processing"]
            MIDISynapses["🎹 MIDI Synapses"]
            OSCTelepathy["📡 OSC Telepathy"]
            AudioAlchemy["🎵 Spectro-Neural Analysis"]
        end
        
        subgraph Layer1["🔥 Layer 1: Electrical Substrate"]
            DMXProtocol["🎭 DMX512 Language"]
            VoltageManipulation["🔌 Voltage Control"]
        end
    end
...
```mermaid
graph TB
    subgraph AudioCortex["🎵 AUDIO PROCESSING MATRIX"]
        AudioInput["🎧 Audio Input"] 
        FFTProcessor["📊 FFT Analysis"]
        BandSeparation["🎼 Band Separation"]
        BeatConsciousness["💓 Beat Detection"]
    ...
    subgraph MIDINeuralNet["🎹 MIDI NEURAL NETWORK"]
        MIDIInterface["🎛️ MIDI Interface"] 
        NeuralLearning["🧠 Learning Algorithm"]
        QuantumScaling["📐 Value Scaling"]
        CCMapping["🗺️ CC Mapping"]
    ...
    subgraph ConvergenceMatrix["🌀 CONVERGENCE NEXUS"]
        BandMapping["🎯 Frequency Mapping"]
        TemporalSync["⚡ Temporal Sync"]
        ValueFusion["💫 Value Fusion"]
    ...
    subgraph ManifestationLayer["💫 MANIFESTATION LAYER"]
        DMXUniverse["🌌 DMX Universe"]
        PhotonicVessels["💎 Light Vessels"]
    ...
    AudioCortex --> ConvergenceMatrix
    MIDINeuralNet --> ConvergenceMatrix
    ConvergenceMatrix --> ManifestationLayer
```
...
graph TB
    ...
    subgraph Visualizers["👁️ Visual Realms"]
        ...
        Canvas2D["🎨 2D Canvas"]
        FFTVis["📊 FFT Display"]
        Heatmap["🌡️ Channel Heat"]
    end

    subgraph Controls["🎛️ Control Matrix"]
        Faders["🎚️ Channel Faders"]
...
graph LR
    ...
    subgraph Protocols["⚡ Protocol Matrix"]
        MIDIProtocol["🎼 MIDI Protocol"]
        OSCProtocol["📡 OSC Protocol"]
        ArtNetProtocol["🌌 ArtNet Protocol"]
        SocketProtocol["🔄 Socket.IO"]
    end

    subgraph Core["🧠 Neural Core"]
        Engine["⚙️ Core Engine"]
        State["💾 State Manager"]
        Effects["✨ Effect Generator"]
    end

    %% Connections with flow direction
    MIDI --> MIDIProtocol --> Engine
    Touch --> OSCProtocol --> Engine
    Engine --> ArtNetProtocol --> Network
    Network --> Fixtures
    State <--> SocketProtocol
    Effects --> Engine
```
...
## 🏛️ **Codebase Architecture Mandala**
...
graph TB
    subgraph "🌟 ROOT NEXUS"
        AppJS["📱 App.js - Supreme Coordinator"]
        IndexJS["🌌 index.js - Bootstrap Oracle"]
    end

    subgraph "🏪 COMPONENT CHAMBERS"
        
        subgraph "🎚️ CONTROL MODULES"
            ChannelControl["🎛️ ChannelControl.tsx"]
            GroupControl["👥 GroupControl.tsx"]
            MasterControl["👑 MasterControl.tsx"]
        end
          
        subgraph "🎭 FIXTURE CONFIGURATION"
            FixtureSetup["⚙️ FixtureSetup.tsx"]
            FixtureGroup["🌺 FixtureGroup.tsx"]
            FixtureLibrary["📚 FixtureLibrary.tsx"]
            ColorPicker["🎨 ColorPicker.tsx"]
            PanTiltControl["🕹️ PanTiltControl.tsx"]
        end
        
        subgraph "🎨 VISUAL RENDERING"
            LightCanvas["🖼️ LightCanvas.tsx"]
            WebGLVisualizer["🔮 WebGLVisualizer.tsx"]
            VisualizationControls["🎛️ VisualizationControls.tsx"]
        end
        
        subgraph "🔧 UTILITY MODULES"
            DebugMenu["🔍 DebugMenu.tsx"]
    ...
    subgraph "🧠 STATE MANAGEMENT"
        StoreIndex["🏛️ store/index.ts"]
        ContextFiles["📁 contexts/"]
    end

    subgraph "🎵 AUDIO PROCESSING"
        AudioAnalyzer["🎵 AudioAnalyzer.tsx"]
        AudioEffects["🎪 AudioEffects.tsx"]
    end

    subgraph "🌐 NETWORK INTERFACES"
        MIDIManager["🎹 MIDIManager.ts"]
        OSCManager["📡 OSCManager.ts"]
        ArtNetManager["🌐 ArtNetManager.ts"]
    end

    subgraph "🎨 UI ELEMENTS"
        DockableComponent["🏗️ DockableComponent.tsx"]
        EffectsList["🎪 EffectsList.tsx"]
    end
...
graph LR
    subgraph "🧠 CORE FUNCTIONS"
        ...
        subgraph "⚡ State Management"
            useState["useState()<br/>🔮 <i>Reactive Hook</i><br/>💭 Local state binding<br/>🔄 Real-time state updates<br/>✨ Component state management"]
            
            useReducer["useReducer()<br/>👑 <i>Complex State Manager</i><br/>🎭 Multi-dimensional state control<br/>🌊 Action-based transformation<br/>⚡ Predictable state mutation"]
            
            useEffect["useEffect()<br/>🌟 <i>Lifecycle Bridge</i><br/>🔄 Mount/unmount hooks<br/>🎯 Side-effect orchestration<br/>💫 Event binding"]
        end
        
        subgraph "🎨 Visual Rendering"
            renderComponent["render()<br/>🖼️ <i>UI Materialization</i><br/>🎭 Virtual DOM rendering<br/>👁️ Visual projection<br/>✨ UI rendering"]
            
            updateCanvas["updateCanvas()<br/>🎨 <i>Visual Refresh</i><br/>🌈 Canvas synchronization<br/>🖌️ Pixel-level drawing<br/>💎 Real-time rendering"]
            
            drawVisualization["drawVisualization()<br/>🔮 <i>Data Visualization</i><br/>📊 Data translation<br/>🌊 Information flow<br/>🎪 Aesthetic interpretation"]
        end
    end
    
    subgraph "🎛️ CONTROL FUNCTIONS"
        direction TB
        
        subgraph "🎚️ Channel Manipulation"
            setChannelValue["setChannelValue()<br/>⚡ <i>Channel Value Setter</i><br/>🎯 Single channel control<br/>🔄 Value transformation<br/>💫 Signal routing"]
            
            updateGroupValues["updateGroupValues()<br/>👥 <i>Group Synchronization</i><br/>🌊 Mass channel updates<br/>🎭 Group coordination<br/>✨ Synchronized changes"]
            
            handleFaderChange["handleFaderChange()<br/>🎛️ <i>Input Handler</i><br/>👆 Human interaction<br/>⚡ Real-time input processing<br/>🌈 Input transformation"]
        end
        
        subgraph "🎹 MIDI Integration"
            startMidiLearn["startMidiLearn()<br/>🧠 <i>Learning Mode</i><br/>🎯 Hardware-software binding<br/>⚡ Learning activation<br/>💫 Controller mapping"]
            
            handleMidiMessage["handleMidiMessage()<br/>📡 <i>MIDI Signal Parser</i><br/>🎵 Binary translation<br/>🔄 Real-time streaming<br/>✨ Hardware processing"]
            
            mapMidiControl["mapMidiControl()<br/>🗺️ <i>Control Mapping</i><br/>🔗 Connection creation<br/>🎛️ Control routing<br/>⚡ Physical-digital binding"]
        end
    end
    ...
    subgraph "🌊 AUDIO PROCESSING"
        ...
        subgraph "🎵 Spectral Analysis"
            analyzeAudio["analyzeAudio()<br/>🔬 <i>Frequency Analyzer</i><br/>📊 FFT decomposition<br/>🌊 Waveform analysis<br/>💫 Signal processing"]
            
            detectBeats["detectBeats()<br/>💓 <i>Rhythm Detector</i><br/>🎯 Pattern recognition<br/>⚡ Beat extraction<br/>🎭 Musical interpretation"]
            
            mapFrequencyToColor["mapFrequencyToColor()<br/>🌈 <i>Audio-Visual Mapping</i><br/>🔮 Sound-to-light conversion<br/>🎨 Synesthetic bridging<br/>✨ Frequency-color translation"]
        end
        
        subgraph "🎪 Audio-Reactive Effects"
            updateReactiveEffects["updateReactiveEffects()<br/>🌟 <i>Audio-Driven Updates</i><br/>🎭 Music-responsive effects<br/>🔄 Audio-visual sync<br/>💫 Rhythmic pulsation"]
            
            processAudioBuffer["processAudioBuffer()<br/>📊 <i>Audio Stream Parser</i><br/>⚡ Buffer processing<br/>🌊 Continuous analysis<br/>🎵 Sonic data handling"]
        end
    end
    ...
    subgraph "🌐 NETWORK PROTOCOLS"
        ...
        subgraph "📡 Communication"
            sendOSCMessage["sendOSCMessage()<br/>📶 <i>Wireless Transmitter</i><br/>🌌 UDP streaming<br/>📡 Network broadcasting<br/>✨ Data transmission"]
            
            receiveDMXData["receiveDMXData()<br/>⚡ <i>DMX Signal Parser</i><br/>🎭 512-channel processing<br/>🔄 Protocol handling<br/>💫 Signal interpretation"]
            
            syncArtNetUniverses["syncArtNetUniverses()<br/>🌌 <i>Universe Synchronizer</i><br/>🌊 Parallel coordination<br/>🎭 Cross-device sync<br/>⚡ Network lighting control"]
        end
        
        subgraph "🔄 Data Transformation"
            convertColorSpace["convertColorSpace()<br/>🌈 <i>Color Translator</i><br/>🔮 RGB/HSV conversion<br/>🎨 Color transformation<br/>💎 Spectral translation"]
            
            scaleValue["scaleValue()<br/>📐 <i>Value Scaler</i><br/>🎯 Range transformation<br/>⚡ Proportional mapping<br/>✨ Value morphing"]
            
            interpolateValues["interpolateValues()<br/>🌊 <i>Smooth Transition</i><br/>🔄 Value blending<br/>💫 Seamless morphing<br/>🎭 Gradual evolution"]
        end
    end
    
    subgraph "💾 PERSISTENCE SYSTEMS"
        direction TB
        
        subgraph "🏛️ Memory Functions"
            saveScene["saveScene()<br/>💎 <i>State Preservation</i><br/>🏛️ State archival<br/>💾 Memory storage<br/>✨ Scene saving"]
            
            loadScene["loadScene()<br/>🔮 <i>State Restoration</i><br/>⚡ Memory retrieval<br/>🌊 State reconstruction<br/>🎭 Scene recall"]
            
            exportProject["exportProject()<br/>📦 <i>Project Export</i><br/>🌟 Complete packaging<br/>💫 Portable export<br/>🎨 Creative preservation"]
        end
    end
...
graph TD
    subgraph "✨ THE ARTISTIC MANIFESTATION PIPELINE"
        ...
        subgraph "🧠 STAGE 1: CREATIVE INCEPTION"
            ...
            InterfaceTouch[("👆 Interface Interaction<br/>⚡ <i>Physical Input</i><br/>🎛️ Fader movements & buttons<br/>🎹 MIDI controller input<br/>🖱️ Mouse/touch interaction")]
        end
        
        subgraph "🔄 STAGE 2: SIGNAL PROCESSING"
            EventCapture[("📡 Event Capture<br/>🧠 <i>Input Signal Processing</i><br/>⚡ React event system<br/>🔄 State change triggers<br/>💫 Digital interpretation")]
            
            ValueTransformation[("🌊 Value Transformation<br/>🔮 <i>Data Manipulation</i><br/>📐 Range scaling<br/>🎯 Precision mapping<br/>✨ Numerical processing")]
            
            MIDIOSCProcessing[("🎵 MIDI/OSC Integration<br/>📶 <i>Protocol Handling</i><br/>🎹 Hardware signal interpretation<br/>📡 Network streams<br/>🌐 Cross-platform bridging")]
        end
        
        subgraph "🎨 STAGE 3: VISUAL RENDERING"
            UIUpdate[("🖼️ UI Visualization<br/>👁️ <i>Visual Presentation</i><br/>🎭 Component rendering<br/>🌈 Color visualization<br/>💎 Interface updates")]
            
            CanvasRendering[("🎨 Canvas Rendering<br/>🖌️ <i>Graphical Output</i><br/>🌊 WebGL acceleration<br/>👁️ 3D visualization<br/>✨ Real-time graphics")]
            
            AudioVisualization[("🎵 Audio-Visual Fusion<br/>🌈 <i>Synesthetic Mapping</i><br/>📊 FFT spectral display<br/>🎭 Beat-reactive visuals<br/>💫 Music-light translation")]
        end
        
        subgraph "⚡ STAGE 4: DMX TRANSLATION"
            StateCalculation[("🧮 State Computation<br/>👑 <i>Central Calculation</i><br/>🎛️ Channel value synthesis<br/>👥 Group harmonization<br/>🌊 Master override logic")]
            
            DMXPacketCreation[("📦 DMX512 Packet Formation<br/>⚡ <i>Protocol Formatting</i><br/>🎭 512-channel data structure<br/>🔢 Binary encoding<br/>💫 Protocol implementation")]
            
            UniverseMapping[("🌌 Universe Mapping<br/>🗺️ <i>Fixture Assignment</i><br/>🎪 Fixture profile integration<br/>🌐 ArtNet distribution<br/>✨ Spatial coordination")]
        end
        
        subgraph "🌐 STAGE 5: NETWORK TRANSMISSION"
            SerialTransmission[("🔌 Serial DMX Stream<br/>⚡ <i>Direct Hardware Connection</i><br/>📡 USB-to-DMX interface<br/>🎭 Professional lighting link<br/>💫 Wired transmission")]
            
            ArtNetBroadcast[("📶 ArtNet Network Broadcasting<br/>🌌 <i>Network Distribution</i><br/>🌐 Ethernet protocols<br/>🎪 Multi-device coordination<br/>✨ Networked synchronization")]
            
            OSCTelemetry[("📡 OSC Telemetry<br/>🌊 <i>Wireless Communication</i><br/>📱 Mobile device bridging<br/>🎛️ Remote control<br/>💫 Wireless operation")]
        end
        
        subgraph "💡 STAGE 6: PHYSICAL MANIFESTATION"
            FixtureReceiver[("🎭 Fixture Reception<br/>⚡ <i>Hardware Processing</i><br/>🔌 DMX signal interpretation<br/>🎪 Moving head response<br/>💡 LED strip activation")]
            
            PhotonicOutput[("✨ Light Output<br/>🌟 <i>Photonic Emission</i><br/>🌈 RGB color projection<br/>💎 Luminal energy<br/>🎨 Physical artistry")]
            
            AudienceExperience[("👥 Audience Experience<br/>🎭 <i>Artistic Reception</i><br/>👁️ Visual perception<br/>💫 Emotional response<br/>✨ Artistic appreciation")]
        end
    end
...
### ⚙️ **Backend Source (src) Directory**
