...
const RESOLUTIONS = {
    ...
    ipad_pro_2019_landscape: { width: 2420, height: 1668, orientation: 'horizontal' },
    samsung_s21_specified_portrait: { width: 1668, height: 2420, orientation: 'vertical' },
    samsung_s21_specified_landscape: { width: 2420, height: 1668, orientation: 'horizontal' },
...
export const generateTouchOscLayout = (options, placedFixtures, // Changed from fixtures: Fixture[]
masterSliders, allFixtures // Added allFixtures for definitions
) => {
...
export const exportToToscFile = async (options, placedFixtures, // Changed
masterSliders, allFixtures, // Added
filename = "ArtBastardOSC.tosc") => {
    try {
