...
const MainPage = () => {
    ...
    const renderContent = () => {
        return (_jsxs("div", { className: styles.content, children: [!connected && (_jsxs("div", { className: styles.connectionWarning, children: [_jsx("i", { className: "fas fa-exclamation-triangle" }), "Connection lost - attempting to reconnect..."] })), _jsxs("div", { className: styles.viewContainer, children: ["          ", currentView === 'main' && (_jsxs("div", { className: styles.mainLayout, children: [_jsx("div", { className: styles.fixedQuickCapture, children: _jsxs("button", { className: styles.quickSaveButton, onClick: handleQuickSave, title: "Quick save current DMX state with timestamp", children: [_jsx("i", { className: "fas fa-bolt" }), theme === 'artsnob' ? 'Quick Capture' : 'Quick Save'] }) }), _jsxs("div", { className: styles.centralContent, children: [_jsx(DmxControlPanel, {}), _jsx(MidiMonitor, {}), _jsx(OscMonitor, {})] }), "              ", _jsxs("div", { className: styles.dockedElements, children: [_jsx("div", { className: styles.leftMiddleDock, children: _jsx(ChromaticEnergyManipulatorMini, { isDockable: false }) }), "                ", _jsx("div", { className: styles.rightMiddleDock, children: _jsx(SceneQuickLaunch, { isDockable: false }) }), _jsx("div", { className: styles.bottomLeftDock, children: _jsx(AutoSceneControlMini, { isDockable: false }) }), _jsx("div", { className: styles.bottomCenterDock, children: _jsx(MasterFader, { isDockable: false }) })] })] })), currentView === 'midiOsc' && _jsx(MidiOscSetup, {}), currentView === 'fixture' && _jsx(FixtureSetup, {}), currentView === 'scenes' && (_jsxs(_Fragment, { children: [_jsx(SceneGallery, {}), _jsx(AutoSceneControl, { isMinimized: isAutoSceneMinimized, onMinimizedChange: setIsAutoSceneMinimized })] })), currentView === 'oscDebug' && _jsx(OscDebug, {}), currentView === 'audio' && _jsx(AudioControlPanel, {}), currentView === 'touchosc' && _jsx(TouchOSCExporter, {}), currentView === 'misc' && _jsx(Settings, {})] })] }));
    };
