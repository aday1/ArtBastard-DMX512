...
export const useGroupMidiLearn = () => {
    const { midiLearnTarget, midiMessages, startGroupMidiLearn, cancelMidiLearn, setGroupMidiMapping, addNotification, } = useStore((state) => ({
    ...
    const startLearn = useCallback((groupId) => {
