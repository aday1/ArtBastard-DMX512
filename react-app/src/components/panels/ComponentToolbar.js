...
export const ComponentToolbar = () => {
    ...
    return (_jsxs("div", { className: `${styles.componentToolbar} ${isCollapsed ? styles.collapsed : ''}`, children: [_jsxs("div", { className: styles.toolbarHeader, children: [_jsxs("h3", { className: styles.toolbarTitle, children: [_jsx("i", { className: "fas fa-toolbox" }), "Component Toolbar"] }), _jsx("div", { className: styles.toolbarControls, children: _jsx("button", { className: styles.collapseButton, onClick: () => setIsCollapsed(!isCollapsed), title: isCollapsed ? 'Expand toolbar' : 'Collapse toolbar', children: _jsx("i", { className: `fas fa-chevron-${isCollapsed ? 'down' : 'up'}` }) }) })] }), !isCollapsed && (_jsxs("div", { className: styles.toolbarContent, children: [_jsxs("div", { className: styles.layoutControls, children: [_jsxs("div", { className: styles.controlGroup, children: [_jsxs("button", { className: styles.controlButton, onClick: () => setShowSaveDialog(!showSaveDialog), title: "Save current layout", children: [_jsx("i", { className: "fas fa-save" }), "Save Layout"] }), _jsxs("button", { className: styles.controlButton, onClick: resetLayout, title: "Reset to default layout", children: [_jsx("i", { className: "fas fa-undo" }), "Reset"] })] }), showSaveDialog && (_jsxs("div", { className: styles.saveDialog, children: [_jsx("input", { type: "text", placeholder: "Layout name...", value: layoutName, onChange: (e) => setLayoutName(e.target.value), className: styles.layoutNameInput }), _jsx("button", { onClick: handleSaveLayout, disabled: !layoutName.trim(), className: styles.saveButton, children: "Save" })] })), savedLayouts.length > 0 && (_jsxs("div", { className: styles.savedLayouts, children: [_jsx("label", { children: "Saved Layouts:" }), _jsx("div", { className: styles.layoutList, children: savedLayouts.map(name => (_jsxs("button", { onClick: () => handleLoadLayout(name), className: styles.layoutButton, title: `Load ${name} layout`, children: [_jsx("i", { className: "fas fa-folder-open" }), name] }, name))) })] }))] }), _jsxs("div", { className: styles.categoryFilter, children: [_jsx("label", { children: "Category:" }), _jsxs("select", { value: selectedCategory, onChange: (e) => setSelectedCategory(e.target.value), className: styles.categorySelect, children: [_jsx("option", { value: "all", children: "All Components" }), categories.map(category => (_jsx("option", { value: category, children: category.toUpperCase() }, category)))] })] }), _jsxs("div", { className: styles.componentList, children: [_jsx("div", { className: styles.listHeader, children: _jsx("span", { children: "Drag components to panels:" }) }), _jsx("div", { className: styles.components, children: getFilteredComponents().map(definition => (_jsx(DraggableComponent, { definition: definition }, definition.type))) })] })] }))] }));
};
