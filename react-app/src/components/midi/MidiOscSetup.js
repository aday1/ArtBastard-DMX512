...
export const MidiOscSetup = () => {
    ...
    const { availableMidiClockHosts, selectedMidiClockHostId, midiClockBpm, setSelectedMidiClockHostId, setMidiClockBpm, } = useStore(state => ({
