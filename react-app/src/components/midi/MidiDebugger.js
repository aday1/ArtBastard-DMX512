...
const MidiDebugger = () => {
    ...
    return (_jsxs("div", { className: styles.midiDebugger, children: [_jsx("button", { onClick: toggleDebugger, className: styles.debuggerButton, children: isOpen ? 'Hide MIDI Debug' : 'Show MIDI Debug' }), isOpen && (_jsxs("div", { className: styles.debuggerContent, children: [_jsx("h3", { children: "MIDI Debug Information" }), _jsxs("div", { className: styles.debugSection, children: [_jsx("h4", { children: "Current Learn Status" }), _jsxs("p", { children: ["Learning Target: ", midiLearnTarget !== null ? JSON.stringify(midiLearnTarget) : 'None'] })] }), _jsxs("div", { className: styles.debugSection, children: [_jsxs("h4", { children: ["MIDI Mappings (", Object.keys(midiMappings).length, ")"] }), _jsx("ul", { children: Object.entries(midiMappings).map(([channel, mapping]) => (_jsxs("li", { children: ["Channel ", channel, ": ", mapping.controller !== undefined
