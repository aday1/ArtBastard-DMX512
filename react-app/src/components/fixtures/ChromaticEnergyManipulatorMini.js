...
const ChromaticEnergyManipulatorMini = ({ isCollapsed = false, onCollapsedChange, isDockable = true, }) => {
    ...
    if (!isDockable) {
        return (_jsx("div", { className: styles.chromaticEnergyManipulatorMini, children: _jsxs("div", { className: styles.container, children: [connectionError && (_jsxs("div", { className: styles.errorMessage, children: [_jsx(LucideIcon, { name: "AlertTriangle" }), _jsx("span", { children: connectionError }), _jsx("button", { onClick: () => setConnectionError(null), className: styles.closeError, children: _jsx(LucideIcon, { name: "X" }) })] })), isUpdating && (_jsxs("div", { className: styles.loadingIndicator, children: [_jsx(LucideIcon, { name: "Loader" }), _jsx("span", { children: "Updating..." })] })), _jsx("div", { className: styles.fixtureSection, children: _jsxs("button", { className: styles.fixtureSelector, onClick: () => setShowFixtureSelect(!showFixtureSelect), title: `Selected: ${selectedFixtureName()}`, children: [_jsx(LucideIcon, { name: "Target" }), _jsx("span", { className: styles.fixtureName, children: selectedFixtureName() }), _jsxs("div", { className: styles.selectorRight, children: [selectedFixtures.length > 0 && (_jsx("span", { className: styles.selectionBadge, children: selectedFixtures.length })), _jsx(LucideIcon, { name: showFixtureSelect ? "ChevronUp" : "ChevronDown" })] })] }) })] }) }));
    }
