...
export const GroupMidiLearnButton = ({ groupId, className }) => {
    ...
    return (_jsxs("button", { className: `${styles.learnButton} ${getButtonClass()} ${className || ''}`, onClick: handleClick, title: hasMapping ? 'Click to remap or right-click to remove' : 'Click to assign MIDI control', onContextMenu: handleContextMenu, children: [isGroupLearning && learnStatus === 'learning' && (_jsx("div", { className: styles.pulsingDot })), _jsx("span", { children: getButtonText() })] }));
};
