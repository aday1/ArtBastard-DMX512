...
export const ColorPicker = ({ fixtureId, rgbChannels = {}, movementChannels = {}, onValuesChange }) => {
    ...
    const handleColorPickerClick = (e) => {
        ...
        if (redChannel !== undefined)
            setDmxChannelValue(redChannel, newColor.r);
        if (greenChannel !== undefined)
            setDmxChannelValue(greenChannel, newColor.g);
        if (blueChannel !== undefined)
            setDmxChannelValue(blueChannel, newColor.b);
    ...
    const handleMovementPickerInteraction = (e) => {
        const canvas = movementCanvasRef.current;
        if (!canvas)
            return;
        // Get click coordinates relative to canvas
        ...
        // Update DMX channels if available
        if (panChannel !== undefined)
            setDmxChannelValue(panChannel, panValue);
        if (tiltChannel !== undefined)
            setDmxChannelValue(tiltChannel, tiltValue);
        // Notify parent component
        if (onValuesChange) {
            onValuesChange({
                pan: panValue,
    ...
    return (_jsxs("div", { className: styles.colorPickerContainer, children: [_jsxs("div", { className: styles.section, children: [_jsx("h3", { className: styles.sectionTitle, children: "RGB Color Control" }), rgbChannels && (redChannel !== undefined || greenChannel !== undefined || blueChannel !== undefined) ? (_jsxs("div", { className: styles.rgbWrapper, children: [_jsx("canvas", { ref: colorCanvasRef, width: 200, height: 200, className: styles.colorCanvas, onClick: handleColorPickerClick }), _jsxs("div", { className: styles.rgbValues, children: [_jsxs("div", { className: styles.rgbValue, children: [_jsx("label", { children: "R:" }), _jsx("input", { type: "number", value: color.r, min: 0, max: 255, onChange: (e) => {
                                                    const val = Math.max(0, Math.min(255, parseInt(e.target.value) || 0));
                                                    setColor(prev => ({ ...prev, r: val }));
                                                    if (redChannel !== undefined)
                                                        setDmxChannelValue(redChannel, val);
                                                    if (onValuesChange)
                                                        onValuesChange({ red: val });
                                                } }), _jsxs("span", { children: ["DMX: ", redChannel !== undefined ? redChannel : 'N/A'] })] }), _jsxs("div", { className: styles.rgbValue, children: [_jsx("label", { children: "G:" }), _jsx("input", { type: "number", value: color.g, min: 0, max: 255, onChange: (e) => {
                                                    const val = Math.max(0, Math.min(255, parseInt(e.target.value) || 0));
                                                    setColor(prev => ({ ...prev, g: val }));
                                                    if (greenChannel !== undefined)
                                                        setDmxChannelValue(greenChannel, val);
                                                    if (onValuesChange)
                                                        onValuesChange({ green: val });
                                                } }), _jsxs("span", { children: ["DMX: ", greenChannel !== undefined ? greenChannel : 'N/A'] })] }), _jsxs("div", { className: styles.rgbValue, children: [_jsx("label", { children: "B:" }), _jsx("input", { type: "number", value: color.b, min: 0, max: 255, onChange: (e) => {
                                                    const val = Math.max(0, Math.min(255, parseInt(e.target.value) || 0));
                                                    setColor(prev => ({ ...prev, b: val }));
                                                    if (blueChannel !== undefined)
                                                        setDmxChannelValue(blueChannel, val);
                                                    if (onValuesChange)
                                                        onValuesChange({ blue: val });
                                                } }), _jsxs("span", { children: ["DMX: ", blueChannel !== undefined ? blueChannel : 'N/A'] })] })] }), _jsx("div", { className: styles.colorPreview, style: { backgroundColor: `rgb(${color.r},${color.g},${color.b})` } })] })) : (_jsx("div", { className: styles.noChannels, children: "This fixture does not have RGB channels configured." }))] }), _jsxs("div", { className: styles.section, children: [_jsx("h3", { className: styles.sectionTitle, children: "Pan/Tilt Control" }), movementChannels && (panChannel !== undefined || tiltChannel !== undefined) ? (_jsxs("div", { className: styles.movementWrapper, children: [_jsx("canvas", { ref: movementCanvasRef, width: 200, height: 200, className: styles.movementCanvas, onClick: handleMovementPickerInteraction }), _jsxs("div", { className: styles.movementValues, children: [_jsxs("div", { className: styles.movementValue, children: [_jsx("label", { children: "Pan:" }), _jsx("input", { type: "number", value: movement.pan, min: 0, max: 255, onChange: (e) => {
                                                    const val = Math.max(0, Math.min(255, parseInt(e.target.value) || 0));
                                                    setMovement(prev => ({ ...prev, pan: val }));
                                                    if (panChannel !== undefined)
                                                        setDmxChannelValue(panChannel, val);
                                                    if (onValuesChange)
                                                        onValuesChange({ pan: val });
                                                } }), _jsxs("span", { children: ["DMX: ", panChannel !== undefined ? panChannel : 'N/A'] })] }), _jsxs("div", { className: styles.movementValue, children: [_jsx("label", { children: "Tilt:" }), _jsx("input", { type: "number", value: movement.tilt, min: 0, max: 255, onChange: (e) => {
                                                    const val = Math.max(0, Math.min(255, parseInt(e.target.value) || 0));
                                                    setMovement(prev => ({ ...prev, tilt: val }));
                                                    if (tiltChannel !== undefined)
                                                        setDmxChannelValue(tiltChannel, val);
                                                    if (onValuesChange)
                                                        onValuesChange({ tilt: val });
                                                } }), _jsxs("span", { children: ["DMX: ", tiltChannel !== undefined ? tiltChannel : 'N/A'] })] })] }), _jsx("div", { className: styles.movementPreview, children: _jsx("div", { className: styles.fixtureHead, style: {
                                        transform: `rotateX(${movement.tilt / 255 * 180 - 90}deg) rotateY(${movement.pan / 255 * 360 - 180}deg)`
                                    }, children: _jsx("div", { className: styles.beam, style: {
                                            backgroundColor: `rgb(${color.r},${color.g},${color.b})`
                                        } }) }) })] })) : (_jsx("div", { className: styles.noChannels, children: "This fixture does not have Pan/Tilt channels configured." }))] })] }));
};
