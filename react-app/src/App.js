...
function App() {
    ...
    return (_jsx(ThemeProvider, { children: _jsx(ChromaticEnergyManipulatorProvider, { children: _jsx(SocketProvider, { children: _jsx(DockingProvider, { children: _jsx(PanelProvider, { children: _jsxs(ExternalWindowProvider, { children: [_jsxs("div", { style: { display: 'none' }, children: [_jsx(MidiDmxProcessor, {}), _jsx(MidiDebugHelper, {}), _jsx(MidiDmxDebug, {})] }), _jsx(HelpOverlay, {}), _jsx(ThemeToggleButton, {}), _jsx(DebugInfo, { position: "top-right" }), _jsx(ErrorBoundary, { children: _jsx(Layout, {}) })] }) }) }) }) }) }));
}
export default App;
