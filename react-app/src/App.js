...
function App() {
    ...
    try {
        return (_jsx(ThemeProvider, { children: _jsxs(SocketProvider, { children: [_jsxs("div", { style: { display: 'none' }, children: [_jsx(MidiDmxProcessor, {}), _jsx(MidiDebugHelper, {}), _jsx(MidiDmxDebug, {})] }), _jsx(ThemeToggleButton, {}), _jsx(DebugInfo, { position: "top-right" }), _jsx(Layout, { children: _jsx(MainPage, {}) })] }) }));
    }
    catch (error) {
